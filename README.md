...
- Minimizing execution time (predicting time of the net) had a great importance as this module is part of a larger data pipeline. The inference latency is 0.03 millisecond per frame.
