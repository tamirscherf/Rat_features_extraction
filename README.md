...
<p align="center"><img src = "https://github.com/tamirscherf/Rat_features_extraction/blob/master/visualization/Tagger_video.gif"></p>
...
#### ResNet Architecture
 ...
 <p align="center"><img src="https://github.com/tamirscherf/My_Code/blob/master/visualization/ResNet_skip_gap.png" width="800" height="374">
...
#### Test set, less than 5° mean error.
A test set sampled randomly from the database(20%).
...
#### Validation set, 6.5° mean error.
A set of 100 tagged images that is not part of the database that the training and test sets are taken from.
