function net = train_single_net(images, direcs, repeat_n)
    %This function trains one net or more, and allows changing desired parameters 
    % of the net. It containes two arcitecture - 
    % custom - 
    % resnet -
    % 
    ...
    if (nargin > 2) && (repeat_n > 1)
            net = train_single_net(images, direcs, repeat_n-1);
    end
end
...
function lgraph = create_layers_resnet(image_size, net_width)
    ...
    my_reg_layer = F_One_RegressionLayer('F1'); %set my regression layer
