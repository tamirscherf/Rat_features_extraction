...
function varargout = New_rat_direction_tagger(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @New_rat_direction_tagger_OpeningFcn, ...
                   'gui_OutputFcn',  @New_rat_direction_tagger_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function New_rat_direction_tagger_OpeningFcn(hObject, eventdata, handles, varargin)
% "global variabels" 
handles.SKIP_FACT = 10;
...
function varargout = New_rat_direction_tagger_OutputFcn(hObject, eventdata, handles)    
